...
from virtuoso_bridge.virtuoso.ops import bind_or_open_cell_view, save_current_cellview
from virtuoso_bridge.virtuoso.schematic.ops import (
    schematic_check,
...
class SchematicEditor:
    ...
    def __enter__(self) -> SchematicEditor:
        self.commands.append("cv = " + bind_or_open_cell_view(self.lib, self.cell, view=self.view, mode=self.mode))
        return self
