...
def layout_bind_current_or_open_cell_view(
    ...
    *,
    ...
    """Bind ``cv`` to any open window for lib/cell/view, else open it."""
    return "cv = " + bind_or_open_cell_view(lib, cell, view=view, view_type=view_type, mode=mode)
